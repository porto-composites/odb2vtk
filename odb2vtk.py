...
def ConvertOdb2Vtk(filename = 'C:\Temp\odb2vtk.txt'):  #Modify the default value of filename here to specify the default configuration file
	...
	RunConverter(odb_path, odbname, vtk_path, piecenum, input_frame, input_step, input_instance)

	print "Total time elapsed: ", time() - starttime, "s"

#Function 2	
def ConvertOdb2VtkP(Odbpath = ' ',Odbname = ' ',vtkpath = ' ',Piecenum = ' ', BeginFrame = ' ', EndFrame =' ', Steps =' ', Instances = ' '):
...
def RunConverter(odb_path, odbname, vtk_path, piecenum, input_frame, input_step, input_instance):
	print "Basic Information:"
	print "Model:",odbname,"; Number of blocks:",piecenum
